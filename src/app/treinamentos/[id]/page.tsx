    ...
    if (!product) {
        ...
        return (
            <div className="bg-gradient-to-tl from-[#412979] to-[#0A0020] shadow ">
               ...
               <div className="w-full h-full bg-training bg-no-repeat bg-cover flex flex-col items-center pb-10 px-6 lg:px-0">
                    <div className="w-full max-w-[930px] lg:pt-28 pt-16">
                        ...
                        <div ref={myTargetRef} className="bg-black py-6 px-8 lg:px-16 rounded-[15px] shadow">
