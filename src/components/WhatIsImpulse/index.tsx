    ...
    return (
        <div className='bg-white pt-32 flex flex-col items-center px-9'>
            <div className='flex flex-col lg:items-center max-w-[1020px] gap-12'>
                <h2 className='text-black text-3xl font-bold font-josefin uppercase leading-[60px]'>O que é a Impulse</h2>
                <p className='text-black text-[15px] font-poppins leading-[30px] lg:text-center'>Somos uma plataforma de treinamentos focada em ensinar sobre profissões ditais e serviços remunerados através da internet. Acreditamos que existe um mercado online capaz de beneficiar milhões de pessoas comuns que sofrem para consguir mais dinheiro e não tem conhecimento sobre como se inserir nesse mercado. Na nossa jornada já impactamos a vida de 170 mil Membros Impulse espalhados em mais de 140 países diferentes. </p>
