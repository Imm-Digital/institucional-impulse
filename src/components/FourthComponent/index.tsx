...
function FloatingBox({ title, description, className, bgStyle, icon }: any) {
    return (
      <div className={`${className} lg:absolute py-6 lg:px-16  lg:bg-gradient-to-tl from-primary shadow to-slate-950 text-white rounded-lg lg:shadow-lg lg:w-[400px]  flex flex-col items-center lg:items-start gap-4 lg:gap-2`}>
  ...
  return (
    <div className="w-full flex flex-col items-center relative bg-white py-24 pb-52 px-6 lg:px-0">
        <div className='w-full max-w-[943px] pt-24 px-4 lg:px-24 bg-gradient-to-tl from-primary to-slate-950 rounded-[20px] shadow z-0'>
            ...
            <div className='bg- flex flex-col items-center lg:py-16'>
