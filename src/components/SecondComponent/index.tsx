  ...
  return (
    <div className='bg-white w-full flex flex-col items-center py-8'>
        <div className='flex justify-between max-w-[1045px] items-center '>
            <div>
                <img className='w-[394px] h-[200px]' src={'https://imagedelivery.net/PFtWkgz-CXgygNiSTt_A-w/ad0e2e2d-342c-4d68-5ee3-4b015755e700/public'} alt={'pessoas-da-impulse'}/>
            </div>
        ...
        <div className='flex max-w-[1156px] mt-[93px] justify-between gap-16'>
            {
                oportunites.map(({id, title, text, subtitle, img}) => (
                    <div key={id} className='w-[342px] h-[547px] bg-violet-400 rounded-[15px] border border-black px-12 pt-20 flex flex-col gap-8'>
