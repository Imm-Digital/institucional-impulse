    ...
    <div className='bg-[#181818] flex flex-col lg:items-center min-h-screen px-6 py-16 lg:px-0 lg:py-0'>
        <div className='lg:w-[1268px] lg:h-[358px] rounded-[20px] shadow-inner lg:bg-oportunites lg:mt-[-140px]'>
            <div className='w-full lg:px-[162px] lg:pt-[104px] flex flex-col gap-4'>
                ...
                <p className='text-softviolet lg:text-white text-2xl lg:text-3xl font-bold font-montserrat uppercase tracking-[6px]'>Oportunidades <br/> de renda</p>
            </div>
        </div>
        <div className='w-full flex flex-col gap-12 max-w-[930px] py-8 lg:py-16'>
            {
